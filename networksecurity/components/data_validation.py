...
class DataValidation:
    def __init__(self,data_ingestion_arifacts:DataIngestionArtifact,
                 data_validation_config: DataValidationConfig):
        
        try:
            self.data_ingestion_artifacts = data_ingestion_arifacts
    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
        try:
            ...
            ## now lets read the test and train data 
            ...
            ## Implements numerical check by yourself 
